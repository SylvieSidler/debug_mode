...
void affiche_commandes(int variable_histoire, SDL_Window* gWindow, SDL_Renderer* gRenderer, TTF_Font* font){
    char* commandes_dispo1 = "\\c ou \\close : Ferme le terminal \n\n\\s ou \\save : Sauvegarde le jeu     \\l[01] ou \\load[01] : Lance la sauvegarde 0 ou 1 \n\n\\m ou \\map : Affiche la carte         \\cm ou \\close_map : Ferme la carte";
    char* commandes_dispo2 = "\n\\dm ou \\debug_mode : Permet de traverser tous les éléments de la carte \n\\n ou \\normal_mode : Permet d'intéragir de nouveau avec le monde";
...
char textinput[300], SDL_Color textColor, SDL_Event events, int sp, int b, int w, int h) {
    ...
    open_terminal(sp,gWindow,gRenderer, GrandPixel);
                ...
                case SDL_KEYDOWN:
                    switch (events.key.keysym.sym) {
                        ...
                        case SDLK_RETURN:
                            ...
                            if ((textinput[0]=='\\' && textinput[1]=='c' && textinput[2]=='m' && textinput[3]=='\0') || (textinput[0]=='\\' && textinput[1]=='c' && textinput[2]=='l' && textinput[3]=='o' && textinput[4]=='s' && textinput[5]=='e' && textinput[6]=='_' && textinput[7]=='m' && textinput[8]=='a' && textinput[9]=='p')) {
                            ...
                            if ((textinput[0]=='\\' && textinput[1]=='d' && textinput[2]=='m' && textinput[3]=='\0') || (textinput[0]=='\\' && textinput[1]=='d' && textinput[2]=='e' && textinput[3]=='b' && textinput[4]=='u' && textinput[5]=='g' && textinput[6]=='_' && textinput[7]=='m' && textinput[8]=='o' && textinput[9]=='d' && textinput[10]=='e')) {
                                *debug_mod=1;
                                text = TTF_RenderText_Solid(GrandPixel,textinput, textColor);
                                if (text ==NULL ){
                                    printf("aaaaaaaah :%s\n",SDL_GetError());
                            ...
                            if ((textinput[0]=='\\' && textinput[1]=='n' && textinput[2]=='\0') || (textinput[0]=='\\' && textinput[1]=='n' && textinput[2]=='o' && textinput[3]=='r' && textinput[4]=='m' && textinput[5]=='a' && textinput[6]=='l' && textinput[7]=='_' && textinput[8]=='m' && textinput[9]=='o' && textinput[10]=='d' && textinput[11]=='e')) {
                                *debug_mod=0;
                                text = TTF_RenderText_Solid(GrandPixel,textinput, textColor);
                                if (text ==NULL ){
                                    printf("aaaaaaaah :%s\n",SDL_GetError());
